  ...
  data: {
    ...
    services: [
      ...
      },
      {
          id: 2,
          title: 'Camping',
          body: 'Experience the serenity of nature and the thrill of camping under starry skies. Our camping trips offer a unique opportunity to disconnect from the world and reconnect with the wonders of the wilderness.',
          imageSrc: 'https://htmldemo.zcubethemes.com/riorelax/img/icon/fe-icon01.png',
          imageAlt: 'parking icon',
      },
      {
