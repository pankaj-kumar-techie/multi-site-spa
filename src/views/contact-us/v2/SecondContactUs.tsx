                        ...
                        <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                            <div className="flex items-start">
                                ...
                                <div className="grow ml-6">
                                    <p className={`font-bold mb-1 ${textColor}`}>Technical support</p> {/* Use dynamic text color */}
                                    <p className={`${textColor}`}>support@example.com</p> {/* Use dynamic text color */}
                                ...
                                <div className="shrink-0">
                                    <div
                                        ...
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas"
                                            ...
                                            className={`w-3 ${textColor}`} // Use dynamic text color
                                            role="img"
                                            xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 288 512">
                                            <path fill="currentColor"
                                                d="M209.2 233.4l-108-31.6C88.7 198.2 80 186.5 80 173.5c0-16.3 13.2-29.5 29.5-29.5h66.3c12.2 0 24.2 3.7 34.2 10.5 6.1 4.1 14.3 3.1 19.5-2l34.8-34c7.1-6.9 6.1-18.4-1.8-24.5C238 74.8 207.4 64.1 176 64V16c0-8.8-7.2-16-16-16h-32c-8.8 0-16 7.2-16 16v48h-2.5C45.8 64-5.4 118.7.5 183.6c4.2 46.1 39.4 83.6 83.8 96.6l102.5 30c12.5 3.7 21.2 15.3 21.2 28.3 0 16.3-13.2 29.5-29.5 29.5h-66.3C100 368 88 364.3 78 357.5c-6.1-4.1-14.3-3.1-19.5 2l-34.8 34c-7.1 6.9-6.1-8.4 0-24.5C238 74.8 207.4 64.1 176 64V16c0-8.8-7.2-16-16-16h-32c-8.8 0-16 7.2-16 16v48h-2.5C45.8 64-5.4 118.7.5 183.6c4.2 46.1 39.4 83.6 83.8 96.6l102.5 30c12.5 3.7 21.2 15.3 21.2 28.3 0 16.3-13.2 29.5-29.5 29.5h-66.3C100 368 88 364.3 78 357.5c-6.1-4.1-14.3-3.1-19.5 2l-34.8 34c-7.1 6.9-6.1-8.4 0-24.5C238 74.8 207.4 64.1 176 64V16c0-8.8-7.2-16-16-16h-32c-8.8 0-16 7.2-16 16v48h-2.5C45.8 64-5.4 118.7.5 183.6c4.2 46.1 39.4 83.6 83.8 96.6l102.5 30c12.5 3.7 21.2 15.3 21.2 28.3 0 16.3-13.2 29.5-29.5 29.5h-66.3C100 368 88 364.3 78 357.5c-6.1-4.1-14.3-3.1-19.5 2l-34.8 34c-7.1-6.9-8.1-18.4-1.9-24.5C238 74.8 207.4 64.1 176 64z">
                                            </path>
                                        </svg>
                                    </div>
                                </div>
                                <div className="grow ml-6">
                                    <p className={`font-bold mb-1 ${textColor}`}>Sales questions</p> {/* Use dynamic text color */}
                                    <p className={`${textColor}`}>sales@example.com</p> {/* Use dynamic text color */}
                                    <p className={`${textColor}`}>+1 234-567-89</p> {/* Use dynamic text color */}
                                </div>
                            </div>
                        </div>
                        <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
                            <div className="flex align-end">
                                <div className="shrink-0">
                                    <div
                                        ...
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas"
                                            data-icon="newspaper"
                                            className={`w-5 ${textColor}`} // Use dynamic text color
                                            role="img"
                                            xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 576 512">
                                            <path fill="currentColor"
                                ...
                                <div className="grow ml-6">
                                    <p className={`font-bold mb-1 ${textColor}`}>Press</p> {/* Use dynamic text color */}
                                    <p className={`${textColor}`}>press@example.com</p> {/* Use dynamic text color */}
                                    <p className={`${textColor}`}>+1 234-567-89</p> {/* Use dynamic text color */}
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="shrink-0">
                                    <div
                                        ...
                                        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bug"
                                            ...
                                            role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                            <path fill="currentColor"
                                                d="M511.988 288.9c-.478 17.43-15.217 31.1-32.653 31.1H424v16c0 21.864-4.882 42.584-13.6 61.145l60.228 60.228c12.496 12.497 12.496 32.758 0 45.255-12.498 12.497-32.759 12.496-45.256 0l-54.736-54.736C345.886 467.965 314.351 480 280 480V236c0-6.627-5.373-12-12-12h-24c-6.627 0-12 5.373-12-12v244c-34.351 0-65.886-12.035-90.636-32.108l-54.736 54.736c-12.498 12.497-32.759 12.497-45.256 0-12.496-12.497-12.496-32.758 0-45.255l60.228-60.228C92.882 378.584 88 357.864 88 336v-16H32.666C15.23 320 .491 306.33.013 288.9-.484 270.816 14.028 256 32 256h56v-58.745l-46.628-46.628c-12.496-12.497-12.496-32.758 0-45.255 12.498-12.497 32.758-12.497 45.256 0L141.255 160h229.489l54.627-54.627c12.498-12.497 32.758-12.497 45.256 0 12.496 12.497 12.496 32.758 0 45.255L424 197.255V256h56c17.972 0 32.484 14.816 31.988 32.9zM257 0c-61.856 0-112 50.144-112 112h224C369 50.144 318.856 0 257 0z">
                                            </path>
                                        </svg>
                                    </div>
                                </div>
                                <div className="grow ml-6">
                                    <p className={`font-bold mb-1 ${textColor}`}>Bug report</p> {/* Use dynamic text color */}
                                    <p className={`${textColor}`}>bugs@example.com</p> {/* Use dynamic text color */}
                                    <p className={`${textColor}`}>+1 234-567-89</p> {/* Use dynamic text color */}
                                </div>
                            </div>
                        </div>
