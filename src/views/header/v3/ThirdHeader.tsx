    ...
    <nav className="bg-teal-500 ">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-8">
        ...
        <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
          {headerData.menu && (
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border  rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-teal-500 dark:border-gray-700">
