        ...
        <section className="h-screen bg-cover"
            ...
            <div className="flex h-full w-full items-center justify-center container mx-auto px-8">
                <div className="max-w-2xl text-center">
                    <TitleCover title={"Coming Soon"} paragraph={"You can subscribe to our newsletter, and let you know\n" +
                        "                        when we are back"} titleSize={"sm:text-5xl"} titleColor={"text-white"} paragraphColor={"text-white"}></TitleCover>
