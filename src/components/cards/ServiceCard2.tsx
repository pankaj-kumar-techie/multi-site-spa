export default function ServiceCard2(props: { icon: any, iconAlt: any, title: any, body: any }) {
    return (
        <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp"
            ...
            <div
                ...
                <h3 className="text-lg leading-normal mb-2 font-semibold text-black">{props.title}</h3>
