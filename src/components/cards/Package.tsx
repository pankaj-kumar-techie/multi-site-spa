...
export default function PackageCard(packageDetail: Package) {
    ...
    return (
        <div className={`bg-${theme.colors.primary}`}>
            <a key={packageDetail.id} href={packageDetail.href} className="group hover:shadow-2xl hover:scale-105 transition-all transform duration-500 shadow-xl rounded-xl">
