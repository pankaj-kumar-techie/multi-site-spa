...
export default function ServiceCard(props: { icon: any, iconAlt: any, title: any, body: any }) {
    ...
    return (
        <div className="w-full px-0 md:px-4 md:w-1/2 lg:w-1/3">
            <div className={`mb-8 hover:${theme.typography.thirdFontColor ?? "text-white"}  rounded-[20px] ease-in-out duration-500 bg-white p-10 shadow-md hover:${theme.background.secondary} hover:shadow-lg md:px-7 xl:px-10`}>
                {props.icon && (
