...
export default function SecondTimeline() {
    return (
        <div className="min-h-screen bg-blue-500 bg-fixed bg-blend-screen py-6 flex flex-col justify-center sm:py-12">
                        ...
                        <div className="flex flex-col sm:flex-row items-center">
                            <div className="flex justify-start w-full mx-auto items-center">
                                <div className="w-full sm:w-1/2 sm:pr-8">
                                    <div className="block p-6 rounded-lg shadow-lg bg-gray-100">
                                        <div className="flex justify-between mb-4">
                                            <h1 className={"text-base text-base-600 font-semibold tracking-wide uppercase"}>WORK EXPERIENCE
                                                </h1>

                                        </div>
                                        <p className="text-gray-700 mb-6"> Working as Software Engineer with good knowledge of front-end and back-end techniques, include design, maintain, modify and debug software.</p>
                                        <div className="flex justify-between mb-4">
                                            <a href="#!"
                                               className="font-medium text-purple-600 hover:text-purple-700 focus:text-purple-800 duration-300 transition ease-in-out text-sm ">Carvia Technologies
                                            </a>
                                            <a href="#!"
