...
export default function FirstTestimonial(props: { data: any }) {
  ...
  <div className="absolute top-0 left-0 w-24 md:w-96 h-full" style={{ background: 'linear-gradient(90deg, #F3F7FA 10.94%, rgba(243, 247, 250, 0) 100%)' }}></div>
  <div className="absolute top-0 right-0 w-24 md:w-96 h-full transform rotate-180" style={{background: "linear-gradient(90deg, #F3F7FA 10.94%, rgba(243, 247, 250, 0) 100%)"}}></div>
  <div className="container px-4 mx-auto">
    <div className="relative max-w-xl text-center mx-auto mb-16">
      <h2 className="font-heading mb-4 text-6xl tracking-tighter">What our clients say</h2>
            ...
            <div className="flex flex-wrap justify-between -m-2 mb-6">
              <div className="w-auto p-2">
                <div className="flex flex-wrap items-center -m-1.5">
                  ...
                  <div className="w-auto p-1.5">
                    <h3 className="font-semibold tracking-tight">Danielle Watkins</h3>
                    <span className="text-sm tracking-tight">@andysm</span>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-wrap justify-between -m-2 mb-6">
              <div className="w-auto p-2">
                <div className="flex flex-wrap items-center -m-1.5">
                  ...
                  <div className="w-auto p-1.5">
                    <h3 className="font-semibold tracking-tight">Fernando Sims</h3>
                    <span className="text-sm tracking-tight">@andysm</span>
                  </div>
                </div>
              </div>
