export default function SecondContactUs() {
    return (
        <>
                                    ...
                                    <div className="shrink-0">
                                        <div
                                            ...
                                            <svg aria-hidden="true" focusable="false" data-prefix="fas"
                                                 ...
                                                 className="w-3 text-white" role="img" xmlns="http://www.w3.org/2000/svg"
                                                 viewBox="0 0 288 512">
                                                <path fill="currentColor"
                                ...
                                <div className="flex align-start">
                                    <div className="shrink-0">
                                        <div
                                            ...
                                            <svg aria-hidden="true" focusable="false" data-prefix="fas"
                                                 data-icon="newspaper"
                                                 className="w-5 text-white" role="img" xmlns="http://www.w3.org/2000/svg"
                                                 viewBox="0 0 576 512">
                                                <path fill="currentColor"
