...
},
{
  ...
  data: {
    ...
    subTitle: "Hero Banner Sub Title is here",
    description: "Pahari Yatri is a travel-focused voice assistant designed to provide personalized and knowledgeable information about mountainous regions, particularly in North India. \n\nIt serves as a reliable companion, offering travel recommendations, real-time updates, and seamless booking capabilities. With elements of nature, a human touch, voice representation, cultural symbols, and a nature-inspired color palette, the logo represents the adventurous spirit and connection to local culture. Pahari Yatri aims to enhance user experiences, promote mountain destinations, and foster a sense of exploration and wanderlust.",
    version: "v1",
    style: "CLASSIC",
    services: null,
    products: null,
