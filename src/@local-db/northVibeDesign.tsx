...
export const northVibeDesign: Section[] = [
  ...
  },
  {
    ...
    data: {
      ...
      subTitle: "Let Your Dreams Come to Life",
      description: "Contact us today to make your dream space a reality.",
      version: "v2",
      style: "CLASSIC",
      services: null,
      products: null,
...

  {
    ...
    data: {
      ...
      portfolios: [
        {
          id: 1,
          name: 'Hotel Building in Manali (4000 sqft)',
        ...
        {
          id: 2,
          name: 'Shop Building in Shimla (3200 sqft)',
        ...
        {
          id: 3,
          name: 'Office Building in Hamirpur (2000 sqft)',
        ...
        {
          id: 4,
          name: 'Home Hotel Building in Mandi (1000 sqft) in Manali (4000 sqft)',
        ...
        {
          id: 5,
          name: 'Hotel Building in Manali (5000 sqft)',
